...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_128 = Integer(128); _sage_const_8 = Integer(8); _sage_const_30000 = Integer(30000); _sage_const_64 = Integer(64); _sage_const_10 = Integer(10); _sage_const_16 = Integer(16); _sage_const_20 = Integer(20); _sage_const_256 = Integer(256); _sage_const_24 = Integer(24)# Set variables in the following three lines
tsec        = _sage_const_128     # Pr[one attacker hash call works] <= 1/2^tsec
maxsigs     = _sage_const_2 **_sage_const_10    # at most 2^72
            ...
            for d in range(_sage_const_4 ,h):                                      # Iterate over number of sub-trees
                if h % d == _sage_const_0  and h <= _sage_const_64 +(h/d):
                    for w in [_sage_const_4 , _sage_const_16 , _sage_const_256 ]:                                # Try different Winternitz parameters
                        ...
                        keygen_hashes = _sage_const_2 **(h/d) * (wots * w + wots + _sage_const_2 ) - _sage_const_1 
                        sign_hashes = d * (_sage_const_2 **(h/d) * (wots * w + wots + _sage_const_2 ) -_sage_const_1  ) + k * (_sage_const_3 *_sage_const_2 **b - _sage_const_1 )
                        if sigsize < maxsigbytes and -sec < _sage_const_2 *tsec:
                           ...
                           print("\t".join(map(str, (sigsize, speed, _sage_const_0 , sec, h,d,b,k,w, _sage_const_0 , keygen_hashes, sign_hashes))))
